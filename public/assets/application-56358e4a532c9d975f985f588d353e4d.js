...
(function() {
  jQuery(function() {
    var channel, channel_id, key, pusher;
    ...
    if (key && channel_id) {
      ...
      return channel.bind('comment', function(data) {
        console.log("data: ", data);
        return $('.comments_list').append($("<li class=comment>").append($("<p>").text(data["content"])));
      });
    }
  });
...
(function() {
  jQuery(function() {
    var event_name, room_id, source, url;
    ...
    if (url !== null) {
      ...
      return source.addEventListener(event_name, function(e) {
        var data, last, last_id, message, message_id, new_id, type;
        ...
        if (last) {
          ...
          if (Number(last_id) < Number(new_id)) {
            return $('.posts_list').append($("<li class=" + message_id + ">").text("" + message));
          }
        }
      });
    }
  ...
  jQuery(function() {
    ...
    if (url !== null) {
      ...
      return source.addEventListener(event_name, function(e) {
        ...
        chat_id = data.id;
        console.log(message);
        return $('.messages_list').append($("<li class=" + chat_id + " message>").append($("<p>").text(message)));
      });
    }
  });
